...
def py_k_ants_terminate(void) -> None:
    k_ants_terminate()
def py_k_ants_configure(config: bytes) -> None:
    k_ants_configure(config)
def py_k_ants_reset(void) -> None:
    k_ants_reset()
def py_k_ants_arm(void) -> None:
    k_ants_arm()
def py_k_ants_disarm(void) -> None:
    k_ants_disarm()
...
def py_k_ants_cancel_deploy(void) -> None:
...
def py_k_ants_watchdog_kick(void) -> None:
    k_ants_watchdog_kick()
def py_k_ants_watchdog_start(void) -> None:
    k_ants_watchdog_start()
def py_k_ants_watchdog_stop(void) -> None:
